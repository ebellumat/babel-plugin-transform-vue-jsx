...
<!-- The example row's hash is the real digest of its own four fields against
     https://github.com/ebellumat/babel-plugin-transform-vue-jsx, so it does not match this repository's URL - it is an
...
npx proof-of-usage hash \
  ...
  --repo "https://github.com/ebellumat/babel-plugin-transform-vue-jsx"
```

```bash
printf '%s' "ExampleModel v2:AI Corp:2026-08-12T14:30:00Z:https://github.com/ebellumat/babel-plugin-transform-vue-jsx" | shasum -a 256
```

```python
import hashlib
hashlib.sha256("ExampleModel v2:AI Corp:2026-08-12T14:30:00Z:https://github.com/ebellumat/babel-plugin-transform-vue-jsx".encode()).hexdigest()
```
